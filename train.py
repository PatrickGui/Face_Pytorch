...
if __name__ == '__main__':
    ...
    parser.add_argument('--margin_type', type=str, default='CosFace', help='InnerProduct, ArcFace, CosFace, SphereFace')
    ...
    parser.add_argument('--model_pre', type=str, default='512_cos_res50_0_01', help='model prefix')
    parser.add_argument('--gpus', type=str, default='1,3,2,0', help='model prefix')
