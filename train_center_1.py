...
def train(args):
    ...
    criterion_center = loss.CenterLoss_noback(trainset.class_nums, args.feature_dim).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_pre', type=str, default='512_mycenter_IR_0_01', help='model prefix')
    parser.add_argument('--gpus', type=str, default='1,3,2', help='model prefix')
