...
from lossfunctions.loss import FisherLoss
...
def train(args):
    ...
    criterion_center = loss.FisherLoss_noback(trainset.class_nums, args.feature_dim).to(device)
    ...
    for epoch in range(1, args.total_epoch + 1):
        ...
        while batch is not None:
            ...
            feature = net(img)
            output,cor = margin(feature, label)
            loss_classi = criterion_classi(output, label)
            loss_center = criterion_center(feature,label)
            total_loss = loss_classi + cor.mean() #+ loss_center * args.weight_center
...
if __name__ == '__main__':
    ...
    parser.add_argument('--backbone', type=str, default='Res50', help='MobileFace, Res50, Res101, Res50_IR, SERes50_IR, SphereNet')
    ...
    parser.add_argument('--model_pre', type=str, default='512_arcface_topcor_0_01', help='model prefix')
    parser.add_argument('--gpus', type=str, default='3,2,1,0', help='model prefix')
